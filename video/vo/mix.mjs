...
const VIDEO = 'C:/Hackathons/Hackathon Build on Canton/tirai/media/tirai-remotion.mp4';
const OUT = 'C:/Hackathons/Hackathon Build on Canton/tirai/media/tirai-remotion-vo.mp4';
...
const filter = `${delays};${mixIn}amix=inputs=${placed.length}:dropout_transition=0,volume=1.6,aresample=48000[vo]`;
