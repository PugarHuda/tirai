...
> it breaks. You see who is actually transacting on Canton rather than just holding, so
...
### 0:00 sampai 0:22, you are not speaking. Do these things.
...
> Tirai, a confidential multi-dealer RFQ desk on Canton. A buyer asks a panel of dealers
> it chooses, each answers with a sealed quote, and no dealer's node ever receives a
> rival's price.
>
> Deck https://tirai.vercel.app/deck
> Code https://github.com/PugarHuda/tirai
>
> `npm run demo` from the repo boots a Canton sandbox and serves this desk on your own
> machine in about two minutes. That is the version I would rather you judged it on.

### 0:22 sampai 0:32, your segment
...
### 0:42 sampai 0:55, group discussion
